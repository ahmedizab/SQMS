...
namespace AspNet.Identity.Oracle
{
    ...
    public class UserClaimsTable
    {
        ...
        public ClaimsIdentity FindByUserId(string userId)
        {
            ...
            const string commandText = @"SELECT * FROM ASPNETUSERCLAIMS WHERE USERID = :USERID";
        ...
        {
            const string commandText = @"DELETE FROM ASPNETUSERCLAIMS WHERE USERID = :USERID";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value = userId, OracleDbType = OracleDbType.Varchar2 },
            };
        ...
        {
            const string commandText = @"INSERT INTO ASPNETUSERCLAIMS (CLAIMVALUE, CLAIMTYPE, USERID) VALUES (:VALUE, :TYPE, :USERID)";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value = userId, OracleDbType = OracleDbType.Varchar2 },
        ...
        {
            const string commandText = @"DELETE FROM ASPNETUSERCLAIMS WHERE USERID = :USERID AND CLAIMVALUE = :VALUE AND CLAIMTYPE = :TYPE";
            var parameters = new List<OracleParameter>
            {
