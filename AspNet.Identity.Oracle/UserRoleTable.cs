...
namespace AspNet.Identity.Oracle
{
    ...
    public class UserRolesTable
    {
        ...
        {
            const string commandText = @"SELECT NAME FROM ASPNETUSERROLES, ASPNETROLES WHERE USERID = :USERID AND ASPNETUSERROLES.ROLEID = ASPNETROLES.ID";
        ...
        {
            const string commandText = @"DELETE FROM ASPNETUSERROLES WHERE USERID = :USERID";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value = userId, OracleDbType = OracleDbType.Varchar2 }
            };
        ...
        {
            const string commandText = @"INSERT INTO ASPNETUSERROLES (USERID, ROLEID) VALUES (:USERID, :ROLEID)";
            var parameters = new List<OracleParameter>
            {
