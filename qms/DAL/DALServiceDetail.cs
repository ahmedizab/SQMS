...
namespace qms.DAL
{
    public class DALServiceDetail
    {
        ...
        public DataTable CallManualToken(int branch_id, int counter_id, string userid, int token_no, out long token_id, out string contact_no, out string service_type, out DateTime start_time, out string customer_name, out string address)
        {
            try
            {
                manager.AddParameter(new OracleParameter("P_BRANCH_ID", branch_id));
        ...
        public void Transfer(int branch_id, string counter_no,long token_id)
        {
            ...
            {
                manager.AddParameter(new OracleParameter("p_branch_id", branch_id));
                manager.AddParameter(new OracleParameter("p_counter_no", counter_no));
                manager.AddParameter(new OracleParameter("p_token_id", token_id));
