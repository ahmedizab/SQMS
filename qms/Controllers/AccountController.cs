...
namespace qms.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult BLogin(string returnUrl)
        {
            ...
            //ViewBag.branch_id = new SelectList("Branch1", "Branch2", "Branch3", "Branch4", "Branch5");
            return View();
        }
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> BLogin(BranchLoginModel model, string returnUrl)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        return View(model);
        ...
        //    // This doesn't count login failures towards account lockout
        //    // To enable password failures to trigger account lockout, change to shouldLockout: true
        //    var result = await SignInManager.PasswordSignInAsync(model.branch_id, model.counter_id, shouldLockout: false);
        //    switch (result)
        //    {
        //        case SignInStatus.Success:
        //            return RedirectToLocal(returnUrl);
